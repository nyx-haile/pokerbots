#!/usr/bin/env python3
"""
Run Optuna tuning over preflop thresholds by launching self-play suites.
"""
import argparse
...
def main():
    parser = argparse.ArgumentParser(description="Tune preflop thresholds with Optuna.")
    ...
    tune_dir = os.path.join(output_root, "optuna_%s" % _timestamp())
    os.makedirs(tune_dir)

    workspace = tempfile.mkdtemp(prefix="optuna_tune_")

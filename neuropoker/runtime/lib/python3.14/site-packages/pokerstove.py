...
class SwigPyIterator(object):
    ...
    __repr__ = _swig_repr
    __swig_destroy__ = _pokerstove.delete_SwigPyIterator

    def value(self):
        return _pokerstove.SwigPyIterator_value(self)

    def incr(self, n=1):
        return _pokerstove.SwigPyIterator_incr(self, n)

    def decr(self, n=1):
        return _pokerstove.SwigPyIterator_decr(self, n)

    def distance(self, x):
        return _pokerstove.SwigPyIterator_distance(self, x)

    def equal(self, x):
        return _pokerstove.SwigPyIterator_equal(self, x)

    def copy(self):
        return _pokerstove.SwigPyIterator_copy(self)

    def next(self):
        return _pokerstove.SwigPyIterator_next(self)

    def __next__(self):
        return _pokerstove.SwigPyIterator___next__(self)

    def previous(self):
        return _pokerstove.SwigPyIterator_previous(self)

    def advance(self, n):
        return _pokerstove.SwigPyIterator_advance(self, n)

    def __eq__(self, x):
        return _pokerstove.SwigPyIterator___eq__(self, x)

    def __ne__(self, x):
        return _pokerstove.SwigPyIterator___ne__(self, x)

    def __iadd__(self, n):
        return _pokerstove.SwigPyIterator___iadd__(self, n)

    def __isub__(self, n):
        return _pokerstove.SwigPyIterator___isub__(self, n)

    def __add__(self, n):
        return _pokerstove.SwigPyIterator___add__(self, n)

    def __sub__(self, *args):
        return _pokerstove.SwigPyIterator___sub__(self, *args)
    def __iter__(self):
        return self

# Register SwigPyIterator in _pokerstove:
_pokerstove.SwigPyIterator_swigregister(SwigPyIterator)
class CardVector(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def iterator(self):
        return _pokerstove.CardVector_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _pokerstove.CardVector___nonzero__(self)

    def __bool__(self):
        return _pokerstove.CardVector___bool__(self)

    def __len__(self):
        return _pokerstove.CardVector___len__(self)

    def __getslice__(self, i, j):
        return _pokerstove.CardVector___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _pokerstove.CardVector___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _pokerstove.CardVector___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _pokerstove.CardVector___delitem__(self, *args)

    def __getitem__(self, *args):
        return _pokerstove.CardVector___getitem__(self, *args)

    def __setitem__(self, *args):
        return _pokerstove.CardVector___setitem__(self, *args)

    def pop(self):
        return _pokerstove.CardVector_pop(self)

    def append(self, x):
        return _pokerstove.CardVector_append(self, x)

    def empty(self):
        return _pokerstove.CardVector_empty(self)

    def size(self):
        return _pokerstove.CardVector_size(self)

    def swap(self, v):
        return _pokerstove.CardVector_swap(self, v)

    def begin(self):
        return _pokerstove.CardVector_begin(self)

    def end(self):
        return _pokerstove.CardVector_end(self)

    def rbegin(self):
        return _pokerstove.CardVector_rbegin(self)

    def rend(self):
        return _pokerstove.CardVector_rend(self)

    def clear(self):
        return _pokerstove.CardVector_clear(self)

    def get_allocator(self):
        return _pokerstove.CardVector_get_allocator(self)

    def pop_back(self):
        return _pokerstove.CardVector_pop_back(self)

    def erase(self, *args):
        return _pokerstove.CardVector_erase(self, *args)

    def __init__(self, *args):
        _pokerstove.CardVector_swiginit(self, _pokerstove.new_CardVector(*args))

    def push_back(self, x):
        return _pokerstove.CardVector_push_back(self, x)

    def front(self):
        return _pokerstove.CardVector_front(self)

    def back(self):
        return _pokerstove.CardVector_back(self)

    def assign(self, n, x):
        return _pokerstove.CardVector_assign(self, n, x)

    def resize(self, *args):
        return _pokerstove.CardVector_resize(self, *args)

    def insert(self, *args):
        return _pokerstove.CardVector_insert(self, *args)

    def reserve(self, n):
        return _pokerstove.CardVector_reserve(self, n)

    def capacity(self):
        return _pokerstove.CardVector_capacity(self)
    __swig_destroy__ = _pokerstove.delete_CardVector

# Register CardVector in _pokerstove:
_pokerstove.CardVector_swigregister(CardVector)
class PokerEvaluationVector(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def iterator(self):
        return _pokerstove.PokerEvaluationVector_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _pokerstove.PokerEvaluationVector___nonzero__(self)

    def __bool__(self):
        return _pokerstove.PokerEvaluationVector___bool__(self)

    def __len__(self):
        return _pokerstove.PokerEvaluationVector___len__(self)

    def __getslice__(self, i, j):
        return _pokerstove.PokerEvaluationVector___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _pokerstove.PokerEvaluationVector___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _pokerstove.PokerEvaluationVector___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _pokerstove.PokerEvaluationVector___delitem__(self, *args)

    def __getitem__(self, *args):
        return _pokerstove.PokerEvaluationVector___getitem__(self, *args)

    def __setitem__(self, *args):
        return _pokerstove.PokerEvaluationVector___setitem__(self, *args)

    def pop(self):
        return _pokerstove.PokerEvaluationVector_pop(self)

    def append(self, x):
        return _pokerstove.PokerEvaluationVector_append(self, x)

    def empty(self):
        return _pokerstove.PokerEvaluationVector_empty(self)

    def size(self):
        return _pokerstove.PokerEvaluationVector_size(self)

    def swap(self, v):
        return _pokerstove.PokerEvaluationVector_swap(self, v)

    def begin(self):
        return _pokerstove.PokerEvaluationVector_begin(self)

    def end(self):
        return _pokerstove.PokerEvaluationVector_end(self)

    def rbegin(self):
        return _pokerstove.PokerEvaluationVector_rbegin(self)

    def rend(self):
        return _pokerstove.PokerEvaluationVector_rend(self)

    def clear(self):
        return _pokerstove.PokerEvaluationVector_clear(self)

    def get_allocator(self):
        return _pokerstove.PokerEvaluationVector_get_allocator(self)

    def pop_back(self):
        return _pokerstove.PokerEvaluationVector_pop_back(self)

    def erase(self, *args):
        return _pokerstove.PokerEvaluationVector_erase(self, *args)

    def __init__(self, *args):
        _pokerstove.PokerEvaluationVector_swiginit(self, _pokerstove.new_PokerEvaluationVector(*args))

    def push_back(self, x):
        return _pokerstove.PokerEvaluationVector_push_back(self, x)

    def front(self):
        return _pokerstove.PokerEvaluationVector_front(self)

    def back(self):
        return _pokerstove.PokerEvaluationVector_back(self)

    def assign(self, n, x):
        return _pokerstove.PokerEvaluationVector_assign(self, n, x)

    def resize(self, *args):
        return _pokerstove.PokerEvaluationVector_resize(self, *args)

    def insert(self, *args):
        return _pokerstove.PokerEvaluationVector_insert(self, *args)

    def reserve(self, n):
        return _pokerstove.PokerEvaluationVector_reserve(self, n)

    def capacity(self):
        return _pokerstove.PokerEvaluationVector_capacity(self)
    __swig_destroy__ = _pokerstove.delete_PokerEvaluationVector

# Register PokerEvaluationVector in _pokerstove:
_pokerstove.PokerEvaluationVector_swigregister(PokerEvaluationVector)
...
class Rank(object):
    ...
    def rankStr(self):
        return _pokerstove.Rank_rankStr(self)
    ...
    def code(self):
        return _pokerstove.Rank_code(self)

    def __repr__(self):
        return _pokerstove.Rank___repr__(self)

    def __hash__(self):
        return _pokerstove.Rank___hash__(self)
...
class Suit(object):
    ...
    def code(self):
        return _pokerstove.Suit_code(self)

    def __repr__(self):
        return _pokerstove.Suit___repr__(self)

    def __hash__(self):
        return _pokerstove.Suit___hash__(self)
...
class Card(object):
    ...
    def __hash__(self):
        return _pokerstove.Card___hash__(self)
...
class CardSet(object):
    ...
    def getHash(self):
        return _pokerstove.CardSet_getHash(self)
    ...
    @staticmethod
    def fromColex(*args):
        return _pokerstove.CardSet_fromColex(*args)
    ...
    def __hash__(self):
        return _pokerstove.CardSet___hash__(self)
...
class PokerEvaluation(object):
    ...
    def toStringPretty(self):
        return _pokerstove.PokerEvaluation_toStringPretty(self)

    def handType(self):
        return _pokerstove.PokerEvaluation_handType(self)
...
class PokerHandEvaluation(object):
    ...
    def size(self):
        return _pokerstove.PokerHandEvaluation_size(self)

    def evals(self):
        return _pokerstove.PokerHandEvaluation_evals(self)
...
class EquityResult(object):
    ...
    def shares(self):
        return _pokerstove.EquityResult_shares(self)

    @staticmethod
    def normalize(results):
        return _pokerstove.EquityResult_normalize(results)
...
class PokerHandEvaluator(object):
    ...
    def setNumDraws(self, arg2):
        return _pokerstove.PokerHandEvaluator_setNumDraws(self, arg2)
    ...
    def evaluateEquity(self, *args):
        return _pokerstove.PokerHandEvaluator_evaluateEquity(self, *args)
